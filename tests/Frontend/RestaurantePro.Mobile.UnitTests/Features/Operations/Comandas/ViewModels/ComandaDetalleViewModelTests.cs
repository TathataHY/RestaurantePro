...
public class ComandaDetalleViewModelTests
{
	...
	public async Task LoadComandaAsync_WithValidId_ShouldLoadComandaAndItems()
	{
		...
		_mockComandasService.Setup(x => x.ObtenerComandaPorIdAsync(comandaId, It.IsAny<CancellationToken>()))
	...
	public async Task LoadComandaAsync_WithEmptyId_ShouldNotLoadData()
	{
		...
		_mockComandasService.Verify(x => x.ObtenerComandaPorIdAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()), Times.Never);
	}
	...
	public async Task ActualizarCantidadAsync_WhenUserCancels_ShouldNotUpdate()
	{
		...
		_mockComandasService.Verify(x => x.ActualizarCantidadProductoAsync(
			It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<int>(), It.IsAny<CancellationToken>()), Times.Never);
	}
	...
	public async Task CambiarEstadoAsync_WithConfirmation_ShouldChangeEstado()
	{
		...
		_mockComandasService.Verify(x => x.CambiarEstadoComandaAsync(
			comandaId, "Entregada", It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Once);
		_mockDialogService.Verify(x => x.ShowAlertAsync(
	...
	public async Task CambiarEstadoAsync_WhenUserCancels_ShouldNotChangeEstado()
	{
		...
		vm.Comanda.Estado.Should().Be("Pendiente");
		_mockComandasService.Verify(x => x.CambiarEstadoComandaAsync(
	...
	public async Task FinalizarComandaAsync_WhenUserCancelsConfirmation_ShouldNotCallService()
	{
		...
		_mockComandasService.Verify(x => x.FinalizarComandaAsync(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Never);
	}
	...
	public async Task CancelarComandaAsync_WhenUserCancelsConfirm_ShouldNotCallService()
	{
		...
		_mockComandasService.Verify(x => x.CancelarComandaAsync(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Never);
	}
	...
	public async Task RefreshAsync_WithValidComanda_ShouldReloadData()
	{
		...
		_mockComandasService.Verify(x => x.ObtenerComandaPorIdAsync(comandaId, It.IsAny<CancellationToken>()), Times.Once);
	}
