...
public class ComandasServiceAdvancedIntegrationTests : IClassFixture<MobileIntegrationTestFixture>
{
    ...
    public ComandasServiceAdvancedIntegrationTests(MobileIntegrationTestFixture fixture)
    {
        _fixture = fixture;
