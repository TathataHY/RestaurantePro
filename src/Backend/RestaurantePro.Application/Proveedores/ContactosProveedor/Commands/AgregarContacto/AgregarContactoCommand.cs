...
/// <summary>
/// Command para agregar un nuevo contacto a un proveedor
/// Gestiona información completa del contacto incluyendo permisos y autorizaciones
/// </summary>
public class AgregarContactoCommand : IRequest<Result<ContactoProveedorDto>>
{
    /// <summary>
    /// ID del proveedor al que se agregará el contacto
    /// </summary>
