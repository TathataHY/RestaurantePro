...
public class CrearEvaluacionProveedorCommandValidator : AbstractValidator<CrearEvaluacionProveedorCommand>
{
    public CrearEvaluacionProveedorCommandValidator()
    {
