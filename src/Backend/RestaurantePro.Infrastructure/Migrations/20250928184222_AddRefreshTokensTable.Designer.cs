...
namespace RestaurantePro.Infrastructure.Migrations
{
    ...
    [Migration("20250928184222_AddRefreshTokensTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantePro.Domain.Operaciones.Reservaciones.Mesas.Entities.Mesa", b =>
                {
                    ...
                    b.Property<bool>("TieneEnchufe")
                        .HasColumnType("bit");

                    b.Property<bool>("TieneSofa")
                        .HasColumnType("bit");

                    b.Property<bool>("TieneVentana")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("RestaurantePro.Infrastructure.Identity.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RefreshTokens", null, t =>
                        {
                            t.HasComment("Tokens de renovación para autenticación en múltiples dispositivos");
                        });
                });
            ...
            modelBuilder.Entity("RestaurantePro.Domain.Comercial.Facturacion.Entities.DetalleFactura", b =>
                {
                    ...
                    b.HasOne("RestaurantePro.Domain.Core.Productos.Entities.Producto", "Producto")
                        .WithMany()
