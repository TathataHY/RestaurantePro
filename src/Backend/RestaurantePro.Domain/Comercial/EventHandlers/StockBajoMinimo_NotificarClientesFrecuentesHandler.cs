namespace RestaurantePro.Domain.Comercial.EventHandlers
{
    ...
    /// </summary>
    public class StockBajoMinimo_NotificarClientesFrecuentesHandler : IDomainEventHandler<RestaurantePro.Domain.Inventario.Ingredientes.Events.Ingrediente.StockBajoMinimo>
    {
        ...
        /// </summary>
        public async Task Handle(RestaurantePro.Domain.Inventario.Ingredientes.Events.Ingrediente.StockBajoMinimo evento, CancellationToken cancellationToken = default)
        {
            try
            {
