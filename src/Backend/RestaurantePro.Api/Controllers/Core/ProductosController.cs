...
public class ProductosController : ControllerBase
{
    ...
    {
        _logger.LogInformation("🛒 GET /api/core/productos - Página: {PageNumber}, Tamaño: {PageSize}", pageNumber, pageSize);
    ...
    {
        _logger.LogInformation("➕ POST /api/core/productos - Creando producto: {Nombre}", command.Nombre);
