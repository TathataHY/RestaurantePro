...
{
    public class ComandaDetalleCreateDtoValidator : AbstractValidator<ComandaDetalleDto>
    {
        private readonly IUnitOfWork _unitOfWork;

        public ComandaDetalleCreateDtoValidator(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(x => x.Cantidad)
                ...
                .MustAsync(async (model, cantidad, _) => 
                    await HayStockSuficiente(model.PlatoId, cantidad))
